...
PATH=/opt/jdk1.6.0_26/bin:$PWD/android-toolchain-eabi/bin:$PATH #$PWD/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.7/bin:$PWD/prebuilts/misc/linux-x86/make:$PATH ## $PWD/prebuilts/gcc/linux-x86/arm/arm-eabi-4.7/bin:
export PATH
