...
public class DmOperation extends Properties implements Comparable<DmOperation> {
    ...
    public static final class InteractionResponse {
        ...
        /*
         * response is used for TAG_SCOMO_NOTIFICATION, CONFIRMATION and CHOICE_LIST. If type is TAG_SCOMO_NOTIFICATION
         * or CONFIRMATION, then it can be one of TIMEOUT, POSITIVE or NEGATIVE. If type is CHOICE_LIST, then it is 
         * the bit flag of choices.
         */
        public final int response;
        /* input is used only for INPUT_QUERY */
        public final String input;

        public InteractionResponse(InteractionType interactionType, int userResponse, String userInput) {
    ...
    private long mId;
    /*
     * mInteractionRecords is used for mRetry after recovery from network errors. This state will not be stored into
     * persistent storage.
     */
    ...
    /**
     * Create an operation instance with timeout equals to DEFAULT_TIMEOUT and max retry equals to DEFAULT_MAX_RETRY.
     * This method will invoke generateId() to feed itself a ID.
     * 
     * @param id Caller should provide ID via this parameter.
     */
    ...
    public int getIntProperty(String key) {
        return Integer.valueOf((String) super.getProperty(key));
    }
    ...
    public byte[] getByteArrayProperty(String key) {
        return decodeByteArray((String) super.getProperty(key));
    }

    public boolean getBooleanProperty(String key) {
        return Boolean.valueOf((String) super.getProperty(key));
    }
    ...
    /**
     * Retry the operation. This method resets the UI interaction iterator and decreases the retry counter.
     */
    ...
    /**
     * Recover the operation. This method resets the UI interaction iterator without decreasing the retry counter.
     */
