...
import com.mediatek.mediatekdm.iohandler.WriteThroughCacheableWrapper;
...
public class SettingNodeIoHandlerFactory {
    ...
    public NodeIoHandler createNodeHandler(String configItem, Uri uri, String parameterString) {
        ...
        String className = "com.mediatek.mediatekdm.operator.cmcc.setting.Dm" + configItem + "NodeIoHandler";
        ...
        try {
            ...
            try {
                ...
                e1.printStackTrace();
                Log.i(TAG.NODEIOHANDLER, "There is no constructor with 2 proper arguments found. Please your code.");
                return null;
            }
        }
        ...
        try {
            if (ctorWith3Args != null) {
                Log.d(TAG.NODEIOHANDLER, "Create IO handler: " + configItem + "(" + uri + "," + parameterString + ")");
