...
public class IMSComponent implements IDmComponent {
    ...
    public void attach(DmService service) {
        mImsManager = (ImsManager) service.getSystemService(Context.IMS_SERVICE);
    ...
    public void configureDmTree(MdmTree tree) {
        // Normal Nodes
        registerNodeIoHandler(tree, "P-CSCF_Address", ImsConstants.IMS_MO_PCSCF, true, StringHandler.class);
        registerNodeIoHandler(tree, "Timer_T1", ImsConstants.IMS_MO_TIMER_1, true, IntegerHandler.class);
        registerNodeIoHandler(tree, "Timer_T2", ImsConstants.IMS_MO_TIMER_2, true, IntegerHandler.class);
        registerNodeIoHandler(tree, "Timer_T4", ImsConstants.IMS_MO_TIMER_4, true, IntegerHandler.class);
        registerNodeIoHandler(tree, "Private_user_identity", ImsConstants.IMS_MO_IMPI, false, StringHandler.class);
        registerNodeIoHandler(tree, "Home_network_domain_name", ImsConstants.IMS_MO_DOMAIN, false, StringHandler.class);
        registerNodeIoHandler(tree, "Resource_Allocation_Mode", ImsConstants.IMS_MO_RESOURCE, true,
                BooleanHandler.class);
        registerNodeIoHandler(tree, "Voice_Domain_Preference_E_UTRAN", ImsConstants.IMS_MO_VOICE_E, true,
                IntegerHandler.class);
        registerNodeIoHandler(tree, "SMS_Over_IP_Networks_Indication", ImsConstants.IMS_MO_SMS, true,
                BooleanHandler.class);
        registerNodeIoHandler(tree, "Keep_Alive_Enabled", ImsConstants.IMS_MO_KEEPALIVE, true, BooleanHandler.class);
        registerNodeIoHandler(tree, "Voice_Domain_Preference_UTRAN", ImsConstants.IMS_MO_VOICE_U, true,
                IntegerHandler.class);
        registerNodeIoHandler(tree, "Mobility_Management_IMS_Voice_Termination", ImsConstants.IMS_MO_MOBILITY, true,
                BooleanHandler.class);
        registerNodeIoHandler(tree, "RegRetryBaseTime", ImsConstants.IMS_MO_REG_BASE, true, IntegerHandler.class);
        registerNodeIoHandler(tree, "RegRetryMaxTime", ImsConstants.IMS_MO_REG_MAX, true, IntegerHandler.class);
        ...
        try {
            ...
            // 2. create new nodes
            String[] publicUserIdentities = mImsManager.readImsMoStringArray(ImsConstants.IMS_MO_IMPU);
        ...
        try {
            ...
            ImsIcsi[] icsiList = mImsManager.readImsIcsiMo();
        ...
        try {
            ...
            // 2. create new nodes & register handlers
            ImsLboPcscf[] addressList = mImsManager.readImsLboPcscfMo();
        ...
        try {
            ...
            // 2. create new nodes & register handlers
            ImsPhoneCtx[] contextList = mImsManager.readImsPhoneCtxMo();
