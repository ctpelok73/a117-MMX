...
/**
        ...
        private void initialTable(SQLiteDatabase db,String table){
            addParameter(db, table, RcsSettingsData.SERVICE_ACTIVATED, 				RcsSettingsData.FALSE);
 ...
 /** BB Drop 1 */
            ...
            addParameter(db, table, RcsSettingsData.JOYN_USER_ALIAS,           			 "");      
            addParameter(db, table, RcsSettingsData.MESSAGING_CAPABILITIES_VALIDITY,   "0");     
            addParameter(db, table, RcsSettingsData.PROVISION_VALIDITY,                "0");
            addParameter(db, table, RcsSettingsData.PROVISIONING_TOKEN_VALIDITY,       "0");
        }
