...
public class HDMINative implements IHDMINative {
    ...
    public boolean getSupported(int type) {
        return sLoaded ? getSupportedNative(type) : false;
    }

    public native boolean getSupportedNative(int type);
	public native boolean hdmi_enable_test(); //chenmeiai added  for test MHL 
}
