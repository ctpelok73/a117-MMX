...
public abstract class VoiceCommandListener {
    ...
    public static final int ACTION_MAIN_VOICE_WEAKUP = ACTION_COMMON + 7;
    ...
    public static final int ACTION_VOICE_WEAKUP_START = ACTION_COMMON + 0;
    public static final int ACTION_VOICE_WEAKUP_NOTIFY = ACTION_COMMON + 1;
