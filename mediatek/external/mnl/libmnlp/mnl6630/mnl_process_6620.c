...
/* FIXME!! George Kuo: 26MHz TCXO on EVBv1!!! */
    //init_cfg.hw_Clock_Freq = 26000000;             // 26MHz TCXO
    //init_cfg.hw_Clock_Drift = 500;                 // 0.5ppm TCXO
    ...
    /*The below setting of Int_LNA_Config is invalid on MT6620*/
    if(gps_nvram_valid == 1)
    {
    ...
    */
    ...
    //init_cfg.u1ClockType = 0xFF;//0xFE;    // wide-range XTAL
    ...
    */
    /*for query different chip version, 
    we use init_cfg.reservedx and init_cfg.reservedy to implement */    	
    ...
    init_cfg.hw_TCXO_Hz = 16368000;            // 16.368MHz TCXO
    //init_cfg.hw_TCXO_Hz = 26000000; //16368000;             // 16.368MHz TCXO
    ...
    driver_cfg.gps_test_mode = mnl_config.test_mode;		
		
    if(mnl_config.dbg2file  == 1){driver_cfg.DebugType = 1;}
    else if(mnl_config.dbg2file  == 2){driver_cfg.DebugType = 2;}
    else if(mnl_config.dbg2file  == 3){driver_cfg.DebugType = 3;}
