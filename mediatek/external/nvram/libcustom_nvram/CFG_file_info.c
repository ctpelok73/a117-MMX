...
CT_ASSERT(sizeof(g_akCFG_File)/sizeof(TCFG_FILE) == AP_CFG_CUSTOM_BEGIN_LID, COMMON_LID_MISMATCH);
CT_ASSERT(sizeof(g_akCFG_File_Custom)/sizeof(TCFG_FILE) == (AP_CFG_CUSTOM_FILE_MAX_LID-AP_CFG_CUSTOM_BEGIN_LID), CUSTOM_LID_MISMATCH);
...
const TABLE_FOR_SPECIAL_LID g_new_nvram_lid[] = 
{
	...
	{ AP_CFG_RDCL_FILE_BATTERY_DATA_LID, 1024 * 1024, 128 * 1024}
#endif
};
