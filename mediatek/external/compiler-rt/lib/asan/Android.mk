...
LOCAL_C_INCLUDES := bionic mediatek/external/compiler-rt/lib mediatek/external/compiler-rt/include
...
LOCAL_C_INCLUDES := \
  ...
  mediatek/external/compiler-rt/lib \
  mediatek/external/compiler-rt/include
#LOCAL_C_INCLUDES := \
#  bionic \
#  external/stlport/stlport \
...
LOCAL_C_INCLUDES := \
        ...
        mediatek/external/compiler-rt/include \
        mediatek/external/compiler-rt/lib \
        mediatek/external/compiler-rt/lib/sanitizer_common/tests
#LOCAL_C_INCLUDES := \
#        bionic \
#        external/stlport/stlport \
#        external/gtest/include \
...
LOCAL_SRC_FILES := $(asan_test_files) tests/asan_test_main.cc
LOCAL_CPP_EXTENSION := .cc
