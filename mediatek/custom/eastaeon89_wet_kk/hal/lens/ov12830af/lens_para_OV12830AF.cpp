...
const NVRAM_LENS_PARA_STRUCT OV12830AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
    ...
    // AF NVRAM
    {
           ...
           0, //i4MacroIdxOffset          
    	{
               ...
               70, 75, 80, 85, 90,   95,   100,   105,   110,   160,
             210,   260,   310,   360,   410,  460,   0,   0,   0,   0
            },
...
UINT32 OV12830AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &OV12830AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pOV12830AF_getDefaultData = OV12830AF_getDefaultData;
