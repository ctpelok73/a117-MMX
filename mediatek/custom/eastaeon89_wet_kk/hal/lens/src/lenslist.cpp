...
#if defined(OV8825TRULYAF)//LINE <> <DATE20130307> <add sensor:truly ov8825> wupingzhou
extern PFUNC_GETLENSDEFAULT pOV8825TRULYAF_getDefaultData;
#endif

#if defined(OV8826AF)//LINE <> <DATE20130408> <add sensor:sunny ov8825 MTM> wupingzhou
extern PFUNC_GETLENSDEFAULT pOV8826AF_getDefaultData;
#endif

#if defined(FM50AF_IMX179)		//LINE <> <20130523> <add sensor:IMX179> lishengli
extern PFUNC_GETLENSDEFAULT pFM50AF_IMX179_getDefaultData;
#endif

#if defined(OV8835AF)//LINE <> <DATE20130626> <add sensor:ov8835,ov12830> wupingzhou
extern PFUNC_GETLENSDEFAULT pOV8835AF_getDefaultData;
#endif

#if defined(OV12830AF)//LINE <> <DATE20130626> <add sensor:ov8835,ov12830> wupingzhou
extern PFUNC_GETLENSDEFAULT pOV12830AF_getDefaultData;
#endif

#if defined(OV12830TRULYAF)//LINE <> <DATE20130626> <add sensor:ov8835,ov12830> wupingzhou
extern PFUNC_GETLENSDEFAULT pOV12830TRULYAF_getDefaultData;
#endif
...
#if defined(FM50AF_IMX179)//LINE <> <20130523> <add sensor:IMX179> lishengli
		{IMX179_SENSOR_ID, IMX179AF_LENS_ID, "FM50AF_IMX179", pFM50AF_IMX179_getDefaultData},
#endif

#if defined(OV8835AF)//LINE <> <DATE20130626> <add sensor:ov8835,ov12830> wupingzhou
		{OV8835MIPI_SENSOR_ID, OV8835AF_LENS_ID, "OV8835AF", pOV8835AF_getDefaultData},
#endif
...
#if defined(OV12830TRULYAF)//LINE <> <DATE20130715> <add sensor:truly ov12830> wupingzhou
		{OV12830_SENSOR_ID_TRULY, OV12830TRULYAF_LENS_ID, "OV12830TRULYAF", pOV12830TRULYAF_getDefaultData},
#endif

#if defined(FM50AF)
	{DUMMY_SENSOR_ID, FM50AF_LENS_ID, "FM50AF", pFM50AF_getDefaultData},	//LINE <> <20130523> <add sensor:IMX179> lishengli
	//{OV8835MIPI_SENSOR_ID, FM50AF_LENS_ID, "FM50AF", pFM50AF_getDefaultData},
#endif
