...
//extern unsigned short OV12830_write_cmos_sensor(unsigned int addr, unsigned int para);
//extern unsigned short OV12830_read_cmos_sensor(unsigned int addr);
extern int iReadReg(u16 a_u2Addr , u8 * a_puBuff , u16 i2cId);
extern int iWriteReg(u16 a_u2Addr , u32 a_u4Data , u32 a_u4Bytes , u16 i2cId);

#define TRACE(fmt, arg...) xlog_printk(ANDROID_LOG_DEBUG, "[OV12830TRULYRaw_OTP] ",  fmt, ##arg)
...
#define OTP_MID               0x02 //sunny :0x01
...
* Return      :  1, success; 0, fail
*******************************************************************************/	
bool otp_update_wb_ov12830_truly(unsigned short golden_rg, unsigned short golden_bg) 
{
...
static void otp_apply_lenc(void)
{
    ...
    OV12830_write_cmos_sensor(0x5000, 0x86); //LENC on
...
* Return      :  1, success; 0, fail
*******************************************************************************/	
bool otp_update_lenc_ov12830_truly(void) 
{
...
*******************************************************************************/
int otp_update_BLC_ov12830_truly(void) 
{
	unsigned char  k;
	unsigned char  temp;
	//select bank 31
