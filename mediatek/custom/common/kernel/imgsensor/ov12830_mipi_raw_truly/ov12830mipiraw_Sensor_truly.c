...
#include "ov12830mipiraw_Sensor_truly.h"
#include "ov12830mipiraw_Camera_Sensor_para_truly.h"
#include "ov12830mipiraw_CameraCustomized_truly.h"
...
#ifdef OV12830_DEBUG
	#define OV12830DB(fmt, arg...) xlog_printk(ANDROID_LOG_DEBUG, "[OV12830Raw_truly] ",  fmt, ##arg)
#else
	#define OV12830DB(fmt, arg...)
#endif

#ifdef OV12830_DEBUG_SOFIA
	#define OV12830DBSOFIA(fmt, arg...) xlog_printk(ANDROID_LOG_DEBUG, "[OV12830Raw_truly] ",  fmt, ##arg)
#else
...
extern bool otp_update_wb_ov12830_truly(unsigned short golden_rg, unsigned short golden_bg);
extern bool otp_update_lenc_ov12830_truly(void);
extern int otp_update_BLC_ov12830_truly(void);
...
static kal_uint16 OV12830_read_cmos_sensor(kal_uint32 addr)
{
...
static void OV12830_Sensor_Init(void)
{
    ...
    OV12830_write_cmos_sensor(0x0100, 0x1); //wupingzhou,avoid sometimes turn green.
    mDELAY(50);

    OV12830_write_cmos_sensor(0x5001, 0x1); //MWB GAIN ENABLE
    OV12830_write_cmos_sensor(0x3406, 0x1); //MWB GAIN ENABLE

    otp_update_wb_ov12830_truly(365,296);//0x16d,0x128
    otp_update_lenc_ov12830_truly();
    otp_update_BLC_ov12830_truly();
...
static UINT32 OV12830GetSensorID(UINT32 *sensorID)
{
    ...
    *sensorID = OV12830_SENSOR_ID_TRULY; //wangyanhui add 
...
static void OV12830SetFlipMirror(kal_int32 imgMirror)
{
    ...
    //OV12830DB("imgMirror:%d\n");
    imgMirror = IMAGE_HV_MIRROR;//LINE <> <DATE20130626> <add sensor:ov8835,ov12830> wupingzhou
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	spin_unlock(&ov12830mipiraw_drv_lock);
	OV12830SetFlipMirror(sensor_config_data->SensorImageMirror);
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	OV12830DB("truly-OV12830Capture OV12830 temp:%x\n",temp);
#endif
...
UINT32 OV12830_MIPI_RAW_SensorInit_truly(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
