...
UINT32 OV8825_TRULY_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//LINE <> <DATE20130307> <add sensor:truly ov8825> wupingzhou
UINT32 OV8826_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//LINE <> <DATE20130408> <add sensor:sunny ov8825 MTM> wupingzhou
...
UINT32 OV8835_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);				//add by lishengli 20130502

UINT32 OV12830_MIPI_RAW_SensorInit_truly(PSENSOR_FUNCTION_STRUCT *pfFunc);//LINE<20130309><for truly camera >wangyanhui
...
#if defined(OV8825_TRULY_MIPI_RAW)//LINE <> <DATE20130307> <add sensor:truly ov8825> wupingzhou
    {OV8825_TRULY_SENSOR_ID, SENSOR_DRVNAME_OV8825_TRULY_MIPI_RAW, OV8825_TRULY_MIPI_RAW_SensorInit}, 
#endif

#if defined(OV8826_MIPI_RAW)//LINE <> <DATE20130408> <add sensor:sunny ov8825 MTM> wupingzhou
    {OV8826_SENSOR_ID, SENSOR_DRVNAME_OV8826_MIPI_RAW, OV8826_MIPI_RAW_SensorInit}, 
#endif
#if defined(OV8835_MIPI_RAW)		//add by lishengli 20130502
...
#if defined(OV12830_MIPI_RAW_TRULY)//LINE<20130309><for truly camera >wangyanhui
    {OV12830_SENSOR_ID_TRULY, SENSOR_DRVNAME_OV12830_MIPI_RAW_TRULY, OV12830_MIPI_RAW_SensorInit_truly}, 
#endif
