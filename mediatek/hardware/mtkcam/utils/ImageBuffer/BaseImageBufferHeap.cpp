...
) const
{
    ...
    MUINT32 const planeImgWidthInBytes = planeImgWidthInPixels*planeBitsPerPixel >> 3;
    //
    if  ( planeBufStridesInBytes < planeImgWidthInBytes )
    {
        MY_LOGE(
            ...
            planeBufStridesInBytes, planeImgWidthInBytes
        );
        return  MFALSE;
    }
    //
