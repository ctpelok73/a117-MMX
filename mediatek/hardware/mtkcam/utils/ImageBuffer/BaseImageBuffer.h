...
public:     ////                    Image Attributes.
    ...
    virtual MUINT32                 getBitstreamSize()                  const   { return mBitstreamSize; }
    virtual MBOOL                   setBitstreamSize(MUINT32 const bitstreamsize);
...
public:     ////                    Buffer Attributes.
    ...
    virtual MINT32                  getFD(MUINT index = 0)             const   { return mspImgBufHeap->getHeapID(index); }
    virtual MINT32                  getFDCount()                       const   { return mspImgBufHeap->getHeapIDCount(); }
    ...
    virtual MUINT32                 getBufStridesInBytes(MUINT index)   const;
...
private:    ////                    Image Attributes.
    ...
    MINT                            mImgFormat;
    MUINT                           mPlaneCount;
    MUINT32                         mBitstreamSize;     // in bytes
    MUINT32                         mStrides[3];        // in bytes
