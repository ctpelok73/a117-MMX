...
_PARAM_MAP_BEG_(eMapEffect)
    ...
    _ADD_STRING_VALUE_MAP_( MtkCameraParameters::EFFECT_NASHVILLE,MEFFECT_NASHVILLE);
    _ADD_STRING_VALUE_MAP_( MtkCameraParameters::EFFECT_HEFE,MEFFECT_HEFE);
    _ADD_STRING_VALUE_MAP_( MtkCameraParameters::EFFECT_VALENCIA,MEFFECT_VALENCIA);
    _ADD_STRING_VALUE_MAP_( MtkCameraParameters::EFFECT_XPROII,MEFFECT_XPROII);
    _ADD_STRING_VALUE_MAP_( MtkCameraParameters::EFFECT_LOFI,MEFFECT_LOFI);
    _ADD_STRING_VALUE_MAP_( MtkCameraParameters::EFFECT_SIERRA,MEFFECT_SIERRA);
    _ADD_STRING_VALUE_MAP_( MtkCameraParameters::EFFECT_KELVIN,MEFFECT_KELVIN);
    _ADD_STRING_VALUE_MAP_( MtkCameraParameters::EFFECT_WALDEN,MEFFECT_WALDEN);
    _ADD_STRING_VALUE_MAP_( MtkCameraParameters::EFFECT_F1977,MEFFECT_F1977);    
