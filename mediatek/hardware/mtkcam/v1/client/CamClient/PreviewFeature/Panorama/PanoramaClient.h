...
protected:
    ...
    virtual MBOOL     allocMem(IImageBufferAllocator::ImgParam &memBuf, sp<IImageBuffer> imgBuf);
    virtual MBOOL     deallocMem(sp<IImageBuffer> imgBuf);
...
protected: 
    ...
    sp<IImageBuffer>  mpMotionBuffer;
    sp<IImageBuffer>  mpPanoramaWorkingBuf;      
